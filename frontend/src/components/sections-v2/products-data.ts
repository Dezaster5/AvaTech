...
export const PRODUCTS: Product[] = [
  // ───────────────────────── ЭТАЛОН (полный) ─────────────────────────
  {
    ...
    subtitle: "Гости сами оформляют покупки и билеты — без участия кассира.",
    whatItDoes:
      "Касса самообслуживания помогает гостям самостоятельно выбирать услуги, оформлять покупки и оплачивать заказ без участия кассира. Решение снижает нагрузку на персонал, ускоряет обслуживание и делает первый контакт гостя с площадкой удобнее.",
    whatItDoesAccent:
      "выбирать услуги, оформлять покупки и оплачивать заказ без участия кассира",
    features: [
      { title: "Самостоятельная покупка", desc: "Гость оформляет вход и услуги сам, без очереди к кассиру.", icon: Ticket },
      //   (неразрывный пробел) связывает «и» с «тарифов», поэтому строка
      // в узкой карточке-булете переносится как «Выбор услуг» / «и тарифов».
      { title: "Выбор услуг и тарифов", desc: "Тарифы, пакеты и дополнительные услуги в одном понятном экране.", icon: ListChecks },
      { title: "Оплата без кассира", desc: "Приём оплаты прямо на киоске освобождает персонал от рутины.", icon: CreditCard },
      { title: "Снижение очередей", desc: "Несколько точек самообслуживания разгружают вход в часы пик.", icon: Gauge },
      { title: "Интеграция с системами", desc: "Продажи и услуги синхронизируются с общей системой учёта.", icon: Network },
    ],
    ...
    mockup: { src: "/products/kassa1.png", width: 714, height: 1282, alt: "Касса самообслуживания AvaTech: самостоятельная покупка" },
    gallery: [
  ...
  },
  {
    ...
    subtitle: "Цифровой инструмент для сотрудников и внутренних процессов.",
    whatItDoes:
      "AVA HR — единая платформа для работы с командой: онбординг, обучение, задачи, дисциплина и аналитика по людям в одном месте. Адаптация ускоряется, а процессы становятся прозрачными вместо ручного контроля.",
    whatItDoesAccent:
      "онбординг, обучение, задачи, дисциплина и аналитика по людям в одном месте",
    features: [
      { title: "Онбординг, обучение, тесты и база знаний", desc: "Новичок проходит адаптацию, курсы и тесты в одном месте.", icon: GraduationCap },
      { title: "Контроль задач, дисциплины и прогресса", desc: "Задачи, сроки и исполнение сотрудников всегда на виду.", icon: ClipboardCheck },
      { title: "Аналитика по сотрудникам и отделам", desc: "Понятные показатели по людям и подразделениям.", icon: BarChart3 },
      { title: "Учёт рабочего времени через QR", desc: "Отметка смены по QR-коду — без бумажных табелей.", icon: QrCode },
      { title: "OKR/KPI, чек-листы, фидбек и треки", desc: "Цели, оценки и карьерные треки для всей команды.", icon: Target },
      { title: "Интеграции с CRM, POS/ERP, SSO", desc: "Связь с вашими системами, облаком и SSO из коробки.", icon: Plug },
    ],
    audience: AUDIENCE_V2,
    effects: [
    ...
    mockup: { src: "/products/hr-tech.png", width: 1448, height: 1086, alt: "HR Tech-приложение AvaTech" },
    gallery: [
