...
export const products: Product[] = [
  {
    ...
    gallery: [
      "/assets/products/self-service-kiosk/КСО_0.png",
  ...
  },
  {
    ...
    description:
      "AVA HR помогает быстро внедрить единую мобильную и веб-платформу для работы с персоналом: онбординг, обучение, база знаний, задачи, дисциплина, посещаемость, аналитика по людям и отделам, OKR/KPI, чек-листы, фидбек, карьерные треки и геймификация. Платформа масштабируется под компанию и может интегрироваться с CRM, POS/ERP, HR-системами, облаком, SSO и зарплатными системами.",
    features: [
      "Онбординг, обучение, тесты и база знаний",
      "Контроль задач, дисциплины, посещаемости и прогресса",
      "Аналитика по сотрудникам, отделам и периодам",
      "Учёт рабочего времени через QR и отчёты",
      "OKR/KPI, чек-листы, фидбек и карьерные треки",
      "Интеграции с CRM, POS/ERP, HR-системами, SSO и зарплатными системами"
    ],
    ...
    businessValue: [
      ...
      "Единая точка для обучения, задач и коммуникации",
      "Понятные цифры вместо ручного контроля",
      "Масштабирование HR-процессов под сеть объектов"
    ],
  ...
  },
  {
    ...
    description:
      "AvaTracker помогает автоматизировать учёт рабочего времени, отслеживать присутствие сотрудников и повышать прозрачность внутренних процессов. При отметке смены система формирует хэш лица: это обезличенный цифровой шаблон, который помогает подтвердить сотрудника без хранения фотографии как обычного изображения. Такой подход снижает ручной контроль, делает фиксацию смен точнее и помогает руководителям видеть, кто, когда и где работает.",
    features: [
      "Учёт рабочего времени",
      "Трекинг сотрудников",
      "Фиксация смен при помощи хэша-лица",
